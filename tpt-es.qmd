...
shp_2023$Statistik <- Statistik

#info14 <- paste0(
#  "\nIndustri Pakaian Jadi",
#  "\nProvinsi: ", shp_2023$Propinsi,
#  "\nJumlah Perusahaan: ", shp_2023$pakaian
#)
#shp_2023$info14 <- info14
```
...
plottpt_23 <- ggplot(shp_2023) +
  geom_sf(aes(fill = total_tpt, label = Statistik)) +
...
#plot14_23 <- ggplot(shp_2023) +
#  geom_sf(aes(fill = pakaian, label = info14)) +
#  scale_fill_viridis_c(limits = range(c(shp_2023$pakaian, shp_2023$tekstil)), name = "") +
#  ggtitle("Sebaran Industri Pakaian Jadi") +
#  theme_void()

#ggplotly(plot14_23, tooltip = "label") %>%
#  layout(
#    annotations = list(
#      x = 1, y = -0.05,
#      xref = "paper", yref = "paper",
...
### Tren industri tekstil dan pakaian jadi 2016-2023
...
#Isu relokasi perusahaan TPT dari suatu wilayah ke wilayah lain dikarenakan faktor kenaikan upah tidak terlihat dari tren pada peta sebaran di bawah sebab seluruh provinsi di Pulau Jawa mengalami penurunan jumlah perusahaan industri TPT.
```
